...
export async function generateMetadata({ params, searchParams }: ShipPageProps): Promise<Metadata> {
    ...
    return {
        ...
        description: `Top World of Warships players in the ${titleLabel} over the current rolling standings window — win rate, battles, and standings on ${realmParam.toUpperCase()}.`,
